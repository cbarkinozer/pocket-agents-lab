...
42. [x] Prototype the first Android expert-streaming foundation: loaded-model expert offset index, bounded native LRU cache, `pread` range reads, JNI controls, async prefetch primitive, and cache telemetry. See `docs/results/2026-09-11-android-expert-cache-mvp.md`.
