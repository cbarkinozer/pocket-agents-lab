...
46. [ ] Replace observational duplicate reads with an actual ggml tensor-buffer/page-cache integration, then repeat cache-budget and cold/warm vanilla A/B measurements.
