...
44. [ ] Add a simple previous-token/transition predictor and measure Top-8 recall, wasted bytes, and predictor overhead on top of the working route-to-cache path.
